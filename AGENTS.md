...
|---|---|
| `docs/decisions_log.md` | **Before changing any decided behaviour.** Seventeen design pivots in "initial → why wrong → current → lesson" form. Many tempting refactors are already discussed and intentional. |
